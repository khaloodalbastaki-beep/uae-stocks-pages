  ...
  function demoNotice(meta) {
    if (meta.provider === "live") {
      return `<div class="disclaimer" style="border-color:var(--ai);color:#56e0bd">
        🟢 <strong>Live prices</strong> — quotes are real, ~15-min delayed (read from the ADX & DFM boards). Prices/changes/indices are real;
    ...
    return `<div class="disclaimer" style="border-color:var(--demo);color:#ff9173">
      ...
      Run with real delayed quotes (UAE_PROVIDER=live). Tickers, sectors and the exposure map are real.</div>`;
  }
  function skel() {
